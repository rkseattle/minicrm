...
export default function DataSettings() {
  ...
  const { enabled: demoDataEnabled, isLoading: demoDataLoading } = useFeatureFlag('demo_data');
  const { enabled: csvImportEnabled, isLoading: csvImportLoading } = useFeatureFlag('csv_import');
