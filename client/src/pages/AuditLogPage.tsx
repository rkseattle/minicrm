      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3">
            ...
            {/* User filter */}
            <div>
              <label htmlFor="filter-user" className="block text-xs font-medium text-gray-500 mb-1">
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          {isLoading ? (
            ...
            <>
              {/* Table header */}
              <div className="hidden md:grid grid-cols-[160px_140px_120px_120px_1fr] gap-3 px-6 py-3 border-b border-gray-200 bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wide">
              ...
              {totalPages > 1 && (
                <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-500" data-testid="audit-log-page-label">
