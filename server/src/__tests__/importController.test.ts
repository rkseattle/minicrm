...
describe('POST /api/admin/import/accounts/run', () => {
  ...
  it('imports accounts and returns a summary with created count', async () => {
...
describe('POST /api/admin/import/contacts/run', () => {
  ...
  it('imports contacts and returns a summary with created count', async () => {
  ...
  it('reports failed rows when a required column mapping is missing from CSV data', async () => {
    // CSV missing email column values
    ...
    expect(res.status).toBe(200);
    expect(res.body.failedCount).toBeGreaterThan(0);
...
describe('POST /api/admin/import/deals/run', () => {
  ...
  it('imports deals and returns a summary with created count', async () => {
