 ...
 * api_token_hash is replaced with the boolean has_api_token.
 */
 ...
 * Removes password_hash, MFA secrets, and recovery code hashes.
 * Replaces api_token_hash with the boolean has_api_token so callers can check
 * whether a token is active without exposing the hash.
 *
