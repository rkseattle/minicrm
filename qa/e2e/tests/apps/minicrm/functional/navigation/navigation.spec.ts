 ...
 *
 * Parallelism:
 *   Tests that mutate the global nav-layout system_settings row are grouped inside
 *   test.describe.serial blocks to prevent parallel workers from overwriting each
 *   other's layout setup. Deep-link and Global UI tests use page.goto directly and
 *   do not depend on the nav-layout setting, so they run in parallel.
 *
 * Mobile-web note:
...
//
// Tests are serial to prevent parallel workers from overwriting the global
// nav-layout setting while another worker's test is still running.
// ---------------------------------------------------------------------------

test.describe.serial('Top Nav layout', () => {
...
test.describe.serial('Left Nav layout', () => {
...
test.describe.serial('Hamburger Nav layout', () => {
...
test.describe.serial('Layout switching', () => {
...
test.describe.serial('Hamburger Menu mechanics', () => {
