 ...
 *   - Network mocks (page.mockRoute) are scoped per-test and cleaned up by the
 *     fixture teardown; they cannot bleed across parallel tests running in
 *     separate worker contexts (each worker has its own page/browser context).
