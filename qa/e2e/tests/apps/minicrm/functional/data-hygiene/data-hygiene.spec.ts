 ...
 *
 * Notes:
 *   - Does not mutate data_hygiene_scoring_config — no @serial tag needed.
...
test('@functional F-HYGIENE3: an admin triggers a manual data hygiene scan from AI Settings and sees the run-accepted confirmation', async ({
  page,
  testData,
  restClient,
}) => {
