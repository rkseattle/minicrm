...
| [Dependency Management](dependencies.md)      | Why transitive versions are pinned, and which tool catches which kind of drift                 | Anyone with a red audit gate or a stale override pin                      |
