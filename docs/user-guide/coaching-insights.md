...
![Rep Coaching Insights, with a rep selector above a list of observations comparing one rep against the team average, each paired with a recommended action](../screenshots/14-coaching-insights.png)
