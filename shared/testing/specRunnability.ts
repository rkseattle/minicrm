 ...
 */
export function isPathExcludedFromNonSerial(specFile: string): boolean {
 ...
 */
export function emitsCoverageDump(specSource: string): boolean {
 ...
 */
export function isReconcilable(specFile: string, specSource: string): boolean {
