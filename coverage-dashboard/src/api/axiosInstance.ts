 ...
 * codebase, no direct DB access (MINCRM-628's "own repo/build/deploy, no
 * shared route table" AC).
 *
 ...
 * independent deployment (this app's own build/deploy target, per
 * MINCRM-628), the API lives on a different origin — VITE_API_BASE_URL
 ...
 * own axiosInstance.ts (MINCRM-365), reimplemented here rather than
